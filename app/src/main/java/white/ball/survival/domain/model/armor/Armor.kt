...
enum class Armor (
    ...
    PUCHICK_ARMOR(R.string.puchick_armor_recipe_item, R.drawable.recipe_item_puchick_armor, ItemUse.ARMOR, 1.5, mutableListOf(), mutableListOf(
        ItemsSlot(Item.PUCHICK_PLATE, 9), ItemsSlot(Item.LEAVES, 3), ItemsSlot(Item.WOOD, 1)
    ), R.drawable.animal_player_in_puchick_armor),
    NURG_ARMOR(R.string.nurg_armor_recipe_item, R.drawable.recipe_item_nurg_armor, ItemUse.ARMOR, 2.0, mutableListOf(Effect.STOP_WEAKNESS), mutableListOf(
        ItemsSlot(Item.NURG_PLATE, 12), ItemsSlot(Item.STONE, 3), ItemsSlot(Item.LEAVES, 3)), R.drawable.animal_player_in_nurg_armor),
    SPORK_ARMOR(R.string.spork_armor_recipe_item, R.drawable.recipe_item_spork_armor, ItemUse.ARMOR, 2.0, mutableListOf(Effect.STOP_WEAKNESS, Effect.STOP_POISONING),
